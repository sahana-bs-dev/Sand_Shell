...
import { FileText, ChevronRight, ChevronDown, RefreshCw } from "lucide-react";
...
export default function FileExplorer({
  ...
  return (
    <div className="w-64 border-r border-border bg-[#0f0f14] p-4 flex flex-col">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="font-semibold text-sm">Files</h3>
        <button
          onClick={loadFiles}
          disabled={isLoading}
          className="rounded p-1 hover:bg-[#1a1a20] transition-colors"
          title="Refresh files"
        >
